...
//For para encontrar sumatoria de y
    ...
    System.out.println("Sumatoria de XY: "+suma_xy);
    ...
    System.out.println("Ingresar valor de X deseado para predecir Y: ");
    double x_deseado=leer.nextDouble();
    ...
    System.out.print("La prediccion de Y calculada es: "+y_calculada);
   }
}
